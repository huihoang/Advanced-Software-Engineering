...
export const mockDoctors: DoctorDto[] = [
  {
    ...
    appointments: [
      ...
      },
      {
        id: 2,
        patientId: 2,
        shift: { id: 2, date: "2025-11-03", time: "11:00 - 12:00" },
        status: "PENDING",
      },
      {
        id: 3,
        shift: { id: 3, date: "2025-11-03", time: "13:00 - 14:00" },
        status: "AVAILABLE",
      },
      {
        id: 4,
        patientId: 2,
        shift: { id: 4, date: "2025-11-03", time: "16:00 - 17:00" },
        status: "COMPLETED",
      },
      {
        id: 5,
        patientId: 1,
        shift: { id: 5, date: "2025-11-03", time: "17:00 - 18:00" },
        status: "CANCELED",
      },
    ],
  },
