...
public class Appointments {
    ...
    public Appointments() {} // no-args constructor cho JPA
    ...
    public void setHospitalDepartment(HospitalDepartments hospitalDepartment) { this.hospitalDepartment = hospitalDepartment; }
