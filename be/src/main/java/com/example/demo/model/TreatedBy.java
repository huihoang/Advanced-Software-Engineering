...
public class TreatedBy {
    ...
    // ===== Getters & Setters =====
    public TreatedById getId() { return id; }
    public void setId(TreatedById id) { this.id = id; }

    public Conditions getCondition() { return condition; }
    public void setCondition(Conditions condition) { 
        this.condition = condition; 
        if (condition != null) this.id.setConditionId(condition.getConditionId());
    }

    public MedicalDepartments getDepartment() { return department; }
    public void setDepartment(MedicalDepartments department) { 
        this.department = department; 
        if (department != null) this.id.setDepartmentId(department.getDepartmentId());
    }
    @Embeddable
    public static class TreatedById implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof TreatedById)) return false;
