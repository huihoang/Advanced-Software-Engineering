...
public class PatientConditions {
    ...
    public Integer getPatientConditionId() { return patientConditionId; }
    public void setPatientConditionId(Integer patientConditionId) { this.patientConditionId = patientConditionId; }
    ...
    public void setCondition(Conditions condition) { this.condition = condition; }
